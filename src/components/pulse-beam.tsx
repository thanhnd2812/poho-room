...
export const PulseBeams = ({children, className}: {children: React.ReactNode, className?: string}) => {
  return (
    <div
      className={cn(
        "flex h-[40rem] relative items-center justify-center antialiased bg-slate-950 overflow-hidden",
        className
      )}
    >
